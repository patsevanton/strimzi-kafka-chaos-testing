...
### IO Chaos (дисковые сбои)

| Файл | Описание | Риск |
|------|----------|------|
| `io-fault.yaml` | I/O ошибки и задержки | Высокий |
...
### При I/O ошибках (io-fault)
- Брокер может стать unhealthy
- Возможна потеря данных в буфере (до flush)
- Leader election на другие брокеры
